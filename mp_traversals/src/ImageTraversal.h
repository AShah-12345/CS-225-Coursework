  ...
  */
  ...
  public:
    ...
    */
    ...
    public:
      ImageTraversal::Iterator& setPoint(Point &newpt);
      //std::vector<Point> getValidNeighbors(const Point &pt) const; //added
      Iterator();
      Iterator(const PNG & png, Point & start, double tolerance, add_function traversal_add, pop_function traversal_pop, int width, int height); //added
      Iterator & operator++();
      Point operator*();
    ...
    private:
      ...
      std::vector<std::vector<bool>> visitedPoint;
