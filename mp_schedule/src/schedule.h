...
std::unordered_map<std::string, std::unordered_set<std::string>> V2DtoUnordered_Map(const V2D &given);
//bool is_valid_student(const std::string& student, const V2D& cv, const V2D& sv);
/**
...
//unordered_map<string, vector<string>> populate_courses_to_map(const V2D &courses);
